...
scores in GDM, OpenAI and Anthropic model cards (`data/ai_rd_benchmarks.csv`), collected from search
snippets only and flagged accordingly. The Marin chapter now draws the 8B and 32B
