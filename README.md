...
Cerebras-GPT reference suites; DeepSeek in progress. Appendix A tabulates the AI R&D benchmark
scores in GDM, OpenAI and Anthropic model cards (`data/ai_rd_benchmarks.csv`), with every cell
verified against the card and flagged by provenance. The Marin chapter now draws the 8B and 32B
